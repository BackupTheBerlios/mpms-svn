...
#  * @var               string TITLE
#  */
TITLE="KDB postgres database abstraction"
...
#  */
PATH_PHPDOC=/home/http/phpdocumentor-1.3.0rc3/phpdoc
...
# make documentation
echo $PATH_PHPDOC -d $PATH_PROJECT -t $PATH_DOCS -ti "$TITLE" -dn $PACKAGES \
