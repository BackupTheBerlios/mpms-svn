...
{ki const="change_lang"}Change Language to{/ki}:&nbsp;
  ...
  <option selected="selected" value="sel">{ki const="sel_lang"}selectlanguage{/ki}</option>
  </select>
...
constructor regarding usag.{/ki}</p>

<p>{ki const="desc3"}Useage is same as Smarty. Only
few minor diferences are in
constructor regarding usag.treci jjjj{/ki}</p>
</body>
</html>
